...
import {
  Mail, Phone, ArrowRight, ArrowUpRight, GraduationCap, Rocket,
...
import { accents, type Icon, type AccentKey } from '@/lib/accents';
import { VERDIQ_URL, GITHUB_URL, LINKEDIN_URL } from '@/data/site';
...
export default function Home() {
  ...
  // Arriving from another route with #section: scroll once the page is up.
  useEffect(() => {
    if (!hash) return;
